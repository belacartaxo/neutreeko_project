...
class NeutreekoGame:
    ...
    def update_obs_screen(self, screen, font1, font2, font3, color, back_button):
        ...
        self.create_text(screen, "This work is an implementation of", font2, WHITE, 260)
        self.create_text(screen, "Jan Kristian Haugland's game:", font2, WHITE, 285)
        self.create_text(screen, "Neutreeko", font2, WHITE, 310)
        self.create_text(screen, "Code and strategies were based on:", font2, WHITE, 355)
        self.create_text(screen, "Professor Luis Paulo Reis’s classes", font2, WHITE, 380)
        self.create_text(screen, "OpenAI's chatGPT prompts", font2, WHITE, 405)
        self.draw_button(screen, 'Back', font3, GREEN_3, back_button,(back_button.x+WIDTH_SMALL_BUTTON/2, back_button.y-HEIGHT_BUTTON/4))
